...
def process_data_MAVRIC(name):
    ...
    df = pd.read_csv('/home/mikolaj@acfr.usyd.edu.au/KITTI_CODE/KITTI_data_processed/kitti_processed_data_obj_global_test.csv')
    df_ego = pd.read_csv('/home/mikolaj@acfr.usyd.edu.au/KITTI_CODE/KITTI_data_processed/kitti_processed_data_camera_global_test.csv')
    ...
    for data_class in ['train', 'val', 'test']:
        ...
        for ns_scene_name in tqdm(ns_scene_names[data_class]):
            ...
            scene = process_scene(ns_scene_name, env, df, df_ego)
        ...
        if len(scenes) > 0:
            data_dict_path = os.path.join("/home/mikolaj@acfr.usyd.edu.au/Trajectron-plus-plus/experiments/processed", 'KITTI' + '_0mean_camera_global_' + data_class +'_full.pkl')
